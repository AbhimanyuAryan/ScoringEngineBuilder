...
# !!! Main.UserApp is configured as an alias for Main.ScoringEngineBuilder and you might encounter it in some tests
using Main.ScoringEngineBuilder, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ScoringEngineBuilder tests" begin
  @includetests ARGS
end
